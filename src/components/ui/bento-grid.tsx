...
export const CARDS = [
    {
        Icon: Link2Icon,
        name: "Broker onboarding",
        description: "Get guided setup support with trusted global broker partners.",
        href: "#",
        cta: "Learn more",
        ...
        background: (
            <Card className="absolute top-10 left-10 origin-top rounded-none rounded-tl-md transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105 border border-border border-r-0">
                <CardHeader>
                    ...
                    <CardDescription>
                        Open and fund your account with guided onboarding support.
                    </CardDescription>
                </CardHeader>
    ...
    {
        Icon: SearchIcon,
        name: "Track market opportunities",
        description: "Quickly review market opportunities with curated trading insights.",
        href: "#",
        cta: "Learn more",
        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                <Input placeholder="Search market updates..." />
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/hdf00c</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/sdv0n0</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/03gndo</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/09vmmw</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/s09vws</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">xentradehub.io/sd8fv5</div>
                </div>
            </Command>
        ),
    },
    ...
    },
    {
        Icon: CalendarIcon,
        name: "Calendar",
        description: "Keep track of your trading plan with our calendar view.",
        className: "col-span-3 lg:col-span-1",
        href: "#",
        cta: "Learn more",
        background: (
